...
namespace WanderMarch.Scripts.App
{
    ...
    public class InputInterpreter 
    {
        ...
        [ShowOnly,SerializeField]private InputActionMap currentInputMap;
        ...
        public void Initialize(InputActionAsset a)
        {
            actions = a;
        ...
        public void SwapInputMaps(string newMap)
        {
            ...
            if (actionMap == null)
            {
                Debug.LogError($"Cannot find action map '{newMap}' in actions '{actions}'");
                return;
            }
